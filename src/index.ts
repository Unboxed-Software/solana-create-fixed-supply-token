...
import { createMint, getMint, getOrCreateAssociatedTokenAccount, getAccount, mintTo, setAuthority, AuthorityType } from '@solana/spl-token';
...
async function main() {
    ...
    console.log(`Our new token is ${tokenData.tokenAddress.toBase58()} and all of the supply (${totalSupply}) resides in token account ${tokenData.tokenAddress.toBase58()}`)
}
